...
router.get('/instances/:instance/contracts', (req: Request, res: Response, next: NextFunction): void => {
	
});

router.post('/instances/:instance/contracts/:contract', async (req: Request, res: Response, next: NextFunction): Promise<void> => {
